...
namespace QuanLyBanHang
{
    ...
    {
        private string _id;
        public ChiTietHoaDonNhap(string id)
        {
            InitializeComponent();
            _id = id;
        }
        ...
        void Display()
        {
            dataGridView_hh.DataSource = BLL_PhieuNhapKho.GetDetailData(_id);
        }

        private void dataGridView1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (dataGridView_hh.Columns[e.ColumnIndex].Name == "DonGiaNhap" && e.Value != null)
            {
